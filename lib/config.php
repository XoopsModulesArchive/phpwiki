<?php
   ...
   // become xoops-compliant
   include("../../mainfile.php");            // define connections, do access control
   include XOOPS_ROOT_PATH.'/header.php';    // put out theme header
   $debug="trigger_error"; $die="trigger_error";
   ...
   rcs_id('$Id: config.php,v 1.2 2005/05/04 19:11:46 dbritton Exp $');
   ...
   // MySQL settings -- see INSTALL.mysql for details on using MySQL
      ...
      $WikiPageStore    = $xoopsDB->prefix("wiki_wiki");
      $ArchivePageStore = $xoopsDB->prefix("wiki_archive");
      $WikiLinksStore   = $xoopsDB->prefix("wiki_wikilinks");
      $WikiScoreStore   = $xoopsDB->prefix("wiki_wikiscore");
      $HitCountStore    = $xoopsDB->prefix("wiki_hitcount");
   ...
   $datetimeformat = "F j, Y h:i:s a";  // may contain time of day
...
//   }
   ...
   // use xoops user instead of above code
   $remoteuser = $xoopsUser->getVar('uname');
